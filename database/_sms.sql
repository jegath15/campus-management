...
INSERT INTO `parents` (`user_id`, `student_id`) VALUES ('P1718791000', 'S1718791292');
...
INSERT INTO `fees` (`student_id`, `total_fee`, `paid_amount`, `due_date`, `status`) VALUES ('S1718791292', 50000, 25000, '2024-12-31', 'Partial');
...
INSERT INTO `payment_methods` (`method_name`, `qr_image`, `details`, `status`) VALUES ('Bank Transfer', '', 'Account No: 123456789\nIFSC: SBIN0001234', 'active');
INSERT INTO `payment_methods` (`method_name`, `qr_image`, `details`, `status`) VALUES ('UPI Scan', 'default_qr.png', 'Scan to pay via UPI.', 'active');

--
-- Insert Parent User
--
INSERT INTO `users` (`id`, `email`, `password_hash`, `role`, `theme`) VALUES ('P1718791000', 'parent@gmail.com', '$2y$10$2MrhbQa30mll8mKG6LPyjuI7CQPC4abCvqrSvczxXVRu4RVueRfoe', 'parent', 'light');
