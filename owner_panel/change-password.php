...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php" style="display:flex; align-items:center; gap:10px;"><img src="../images/1.jpeg" style="width:2.5rem;height:2.5rem;border-radius:50%;"><h2 style="margin:0; font-weight:800; font-size:1.8rem; color:var(--dark);">C<span style="color:var(--danger, #ff7782);">M</span>S</h2></a>
