...
<body>
    ...
    <div class="container py-5 mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold m-0">Student Enrollment</h2>
                <p class="text-muted small mb-0">Overview of all active students in the institution.</p>
            </div>
            <div class="d-flex gap-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control border-start-0 px-3" id="search-student" placeholder="Search students..." style="min-width: 250px;">
                </div>
                <select class="form-select rounded-end-pill px-4" id="form-select" style="min-width: 180px;">
                    <option value="" selected>Filter by Year</option>
                    <option value="12m">YEAR I</option>
                    <option value="12b">YEAR II</option>
                    <option value="12c">YEAR III</option>
                    <option value="11m">YEAR IV</option>
                </select>
            </div>
        </div>
