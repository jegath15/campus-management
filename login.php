...
if (isset($_SESSION['uid'])) {
  ...
  if ($row && isset($row['role'])) {
    if ($row['role'] == "admin") {
      header('Location: ' . BASE_URL . 'admin_panel/dashboard.php');
      exit();
    } else if ($row['role'] == "owner") {
      header('Location: ' . BASE_URL . 'owner_panel/index.php');
      exit();
    } else if ($row['role'] == "teacher") {
      header('Location: ' . BASE_URL . 'teacher_panel/dashboard.php');
      exit();
    } else if ($row['role'] == "student") {
      header('Location: ' . BASE_URL . 'student_panel/index.php');
      exit();
    } else if ($row['role'] == "parent") {
      header('Location: ' . BASE_URL . 'parent_panel/dashboard.php');
      exit();
    }
  }
}
  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">CAMPUS MANAGEMENT SYSTEM<br></span>
...
<link rel="stylesheet" href="ai-chat.css?v=<?php echo time(); ?>">
<script src="ai-chat.js?v=<?php echo time(); ?>"></script>
</body>
