...
if (isset($_SESSION['uid'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $image = '<span class="material-icons-sharp text-success" style="font-size: 1.2rem;">circle</span>';
            if ($importance == "2") {
                $image = '<span class="material-icons-sharp text-warning" style="font-size: 1.2rem;">circle</span>';
            } else if ($importance == "3") {
                $image = '<span class="material-icons-sharp text-danger" style="font-size: 1.2rem;">circle</span>';
            }
