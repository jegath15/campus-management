...
<div class="sidebar">
    ...
    <ul class="side-menu main-side-board">
        ...
        <li><a href="subjects.php"><i class='bx bxs-book-bookmark'></i>Subjects</a></li>
        ...
        <li><a href="notes.php"><i class='bx bxs-note'></i>Notes</a></li>
        <li><a href="marks.php"><i class='bx bxs-paste'></i>Marks</a></li>
