<div class="showAttendence feedback">
    ...
    <div class="container" style="display: flex;">
        ...
        <div class="row g-3 align-items-center">
            <div class="col-auto">
                <label for="inputPassword6" class="col-form-label px-1">&nbsp;YEAR&nbsp; </label>
            </div>
            <div class="col-auto">
                <select class="form-select" aria-label="Default select example" id="feedback-search-class">
                    <option value="12c">YEAR IV</option>
<option value="11c">YEAR III</option>
<option value="12s">YEAR II</option>
<option value="11s">YEAR I</option>
